...
import type { CartesianViewType, PolarViewType, RangeViewType, VisualContentConfig } from '@/index';
...
export function useHighcharts() {
    ...
    async function renderCartesianChart(type: CartesianViewType, content: VisualContentConfig, element: HTMLElement, callback?: () => void): Promise<HighchartsView> {
    ...
    async function renderPolarChart(type: PolarViewType, content: VisualContentConfig, element: HTMLElement, callback?: () => void): Promise<HighchartsView> {
    ...
    async function renderRangeChart(type: RangeViewType, content: VisualContentConfig, element: HTMLElement, callback?: () => void): Promise<HighchartsView> {
        await Promise.all([loadHighchartsCore(), loadHighchartsMoreModule()]);
        const series: SeriesOptionsType[] = [];
